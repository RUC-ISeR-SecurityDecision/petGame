(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Global/pet.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1b4aeUPPPVBJritkQmMe9gJ', 'pet', __filename);
// Global/pet.js
...
cc.Class({
    ...
    // 宠物睡觉结束
    sleepEnd: function sleepEnd() {
        this.flagSleep = 0;
    },

    // 宠物工作操作
    goWork: function goWork() {
        if (this.flagPetOperBtnEnable == true) {
            this.flagWork = 1;
        } else {
            console.log("宠物正忙");
