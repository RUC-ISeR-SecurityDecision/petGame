...
cc.Class({
    ...
    loadSound: function loadSound() {
        var self = this;
        cc.loader.loadRes('sound/button/1.mp3', cc.AudioClip, function (err, btnSound) {
            if (err) {
    ...
    startCountDown: function startCountDown(operationName, id, QANum, picNum) {
